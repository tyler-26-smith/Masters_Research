...
fp1.1 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp1.1.csv")
fp1.2 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp1.2.csv")
fp1.3 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp1.3.csv")
fp1.4 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp1.4.csv")
fp1.5 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp1.5.csv")
fp2.1 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp2.1.csv")
fp2.2 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp2.2.csv")
fp2.3 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp2.3.csv")
fp2.4 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp2.4.csv")
fp2.5 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp2.5.csv")
fp3.1 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp3.1.csv")
fp3.2 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp3.2.csv")
fp3.3 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp3.3.csv")
fp3.4 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp3.4.csv")
fp3.5 <- read.csv("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/Lidar profiles prelim analy/fp3.5.csv")



fp1.1$change_from_bank= 0
fp1.1$change_from_bank[1] = fp1.1$Elevation[1]
  
  for (i in 1:nrow(fp1.1)) {
    fp1.1$change_from_bank[i] <- ((fp1.1$Elevation[i] - fp1.1$Elevation[1])/ fp1.1$Elevation[1])*100
  }
...
read_func <- function(doc_name){
  setwd("C:/Users/tylersmith22/Documents/Micro Plastics/R_analy/xsec_extend_profile")
